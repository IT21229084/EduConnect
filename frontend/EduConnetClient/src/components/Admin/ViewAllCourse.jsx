        ...
        <div class="mx-auto grid max-w-screen-xl grid-cols-1 gap-6 p-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <article class="rounded-xl bg-white p-3 shadow-lg hover:shadow-xl">
            <a href="#">
              ...
              <div class="mt-1 p-2">
                <h2 class="text-slate-700">Python For Begineers</h2>
                <p class="text-slate-400 mt-1 text-sm">A to Z programming for Absolute Beginners</p>

                <div class="mt-3 flex items-end justify-between">
                  <p>
                    <span class="text-lg font-bold text-blue-500">$85</span>
                    <span class="text-slate-400 text-sm">Beginner Level</span>
                  </p>
