...
const StudentManagament = () => {
    ...
    const deleteStudentApiCall = (event) => {
        axios
            .post("http://localhost:5050/api/coursedelivery/deleteStudent", {
    ...
    const getApi = () => {
        //useed for making HTTP request from the node.js
        axios
    ...
    const addStudentApi = (name, email, phone) => {
        axios
            .post("http://localhost:5050/api/coursedelivery/addStudent", {
                name: name,
                email: email,
                phone: phone,
            })
    ...
    // onfinish Edit driver manage form
    const editStudentApi = (name, email, phone) => {
        axios
            .post("http://localhost:5050/api/coursedelivery/editDriver", {
                studentId: selectedStudentId,
                name: name,
                email: email,
                phone: phone,
    ...
    return (
        <div className="container-fluid mx-5">
            <div className="mt-auto mb-auto" style={{ height: "100vh" }}>
                {contextHolder}
                {contextHolderModal}
                <h3 className="mt-3">Student Management</h3>
                <div className="row">
                    <div className="col-6">
