  ...
  return (
    <div className="container">
      <div className="row mb-5">
        ...
        <div className="col-md-6 order-md-1">
          <h2 className="main-header">
            Elevate your learning experience <br /> with our intuitive course management platform.
          </h2>
          <p className="main-para">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ac velit a est sagittis blandit. Mauris consectetur mollis sem, sed lobortis leo eleifend eu. Ut sit amet ipsum nulla. Nulla vel est quis mi congue egestas.
          </p>
          <div className="btn-container d-flex justify-content-center align-items-center">
            <Link to='/course-delivery-management'><button className="shop-btn">ENROLL NOW</button></Link>
            <button className="about-btn">ABOUT US</button>
          </div>
        </div>
      </div>
      ...
      <div className="content container-fluid mb-5">
        <div className="container mt-5 mb-5 store-container">
          <div className="row mt-4">
            <div className="col-md-6">
              <img src={storeImage} alt={"store"} className="img-fluid mx-auto d-block" />
            </div>
            <div className="col-md-6 mb-5">
              <h2 className="text-center store-header mb-5">Why Choose Us</h2>
              <div className="row row-cols-2">
                <div className="col mb-5 ml-5">
                  <img src={qualityImage} alt={"quality"} className="img-fluid d-block col-md-3 float-left" />
                  <h5 className="text-left">Top Quality</h5>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut la</p>
                </div>
                <div className="col">
                  <img src={deliveryImage} alt={"delivery"} className="img-fluid d-block col-md-3" />
                  <h5 className="text-left">Fast Delivery</h5>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut la</p>
                </div>
                <div className="col mb-5">
                  <img src={cashImage} alt={"cashback"} className="img-fluid d-block col-md-3 float-left" />
                  <h5 className="text-left">Cashback Reward</h5>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut la</p>
                </div>
                <div className="col">
                  <img src={paymentImage} alt={"payment"} className="img-fluid d-block col-md-3" />
                  <h5 className="text-left">Secure Payment</h5>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut la</p>
                </div>
              </div>
      ...
      <div className="arrival-container">
        ...
        <div className="row mt-5">
          <div className="col-md-3 arrival-img">
            <img src={twoImage} alt={"arrival"} className="img-fluid arrival-img" />
            <h5>Computer Science Section 1</h5>
            <p className="mb-5">Rs 1500</p>
          </div>
          <div className="col-md-3 arrival-img">
            <img src={twoImage} alt={"arrival"} className="img-fluid arrival-img" />
            <h5>Computer Science Section 2</h5>
            <p className="mb-5">Rs 2000</p>
          </div>
          <div className="col-md-3 arrival-img">
            <img src={fourImage} alt={"arrival"} className="img-fluid arrival-img" />
      ...
      <div className="container-fluid">
        ...
        <div className="row justify-content-center">
          <div className="col-md-4">
            <img src={fiveImage} alt={"collection"} className="img-fluid" />
          </div>
          <div className="col-md-4">
            <img src={sixImage} alt={"collection"} className="img-fluid mt-5" />
          </div>
          <div className="col-md-4">
            <img src={sevenImage} alt={"collection"} className="img-fluid" />
          </div>
        </div>
      </div>
      <div className="container mb-5">
        ...
        <div className="row">
          <div className="col-md-4">
            <img src={eightImage} alt={"popular"} className="img-fluid" />
            <h5>MERN Stack Full Course</h5>
            <p>Rs 3000</p>
            <Link to='/course-delivery-management'>
            <button className="add-to-cart d-flex justify-content-center align-items-center">
              Enroll Now
            </button>
            </Link>
          ...
          <div className="col-md-4">
            <img src={nineImage} alt={"popular"} className="img-fluid" />
            <h5>SQL Full Course</h5>
            <p>Rs 3000</p>
            <Link to='/course-delivery-management'>
            <button className="add-to-cart">Enroll Now</button>
            </Link>
          </div>
          <div className="col-md-4">
            <img src={tenImage} alt={"popular"} className="img-fluid" />
            <h5>SpringBoot Microservices Course</h5>
            <p>Rs 6000</p>
            <Link to='/course-delivery-management'>
            <button className="add-to-cart">Enroll Now</button>
            </Link>
